...
| GPT-4o-mini offline | 0.352 | 0.688 | 0.620 | 0.061 | 0.225 | 0.100 |
...
| GPT-4o-mini + RAG (Qwen) | — | — | — | 0.126 | 0.275 | 0.152 |
| GPT-4o-mini + RAG (pplx-ctx) | — | — | — | 0.126 | 0.269 | 0.155 |
| GPT-4o-mini + Exa evidence | — | — | — | 0.121 | 0.312 | 0.161 |
| DeepSeek V4 Flash + RAG (pplx-ctx) | — | — | — | 0.158 | 0.331 | 0.229 |
| DeepSeek V4 Pro + RAG (pplx-ctx) | — | — | — | 0.144 | 0.338 | 0.087 |
...
| GPT-4o-mini offline | 0.061 | 0.225 | 0.100 | 0.141 | 0.463 | 0.310 | 0.546 | 0.900 | 0.552 | 0.683 | 0.944 | 0.839 |
| GPT-4o-mini + RAG (Qwen) | 0.126 | 0.275 | 0.152 | 0.223 | 0.519 | 0.384 | 0.618 | 0.912 | 0.646 | 0.766 | 0.963 | 0.897 |
| GPT-4o-mini + RAG (pplx-ctx) | 0.126 | 0.269 | 0.155 | 0.244 | 0.512 | 0.431 | 0.747 | 0.944 | 0.698 | 0.892 | 0.981 | 0.945 |
| GPT-4o-mini + Exa evidence | 0.121 | 0.312 | 0.161 | 0.317 | 0.675 | 0.411 | 0.614 | 0.925 | 0.639 | 0.637 | 0.944 | 0.818 |
| DeepSeek V4 Flash + RAG (pplx-ctx) | 0.158 | 0.331 | 0.229 | 0.338 | 0.681 | 0.445 | 0.783 | 0.956 | 0.637 | 0.864 | 0.975 | 0.959 |
| DeepSeek V4 Pro + RAG (pplx-ctx) | 0.144 | 0.338 | 0.087 | 0.379 | 0.738 | 0.361 | 0.691 | 0.944 | 0.591 | 0.790 | 0.969 | 0.892 |
