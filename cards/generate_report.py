...
parser.add_argument("--split", default="val", choices=["val", "test", "twitter"])
...
# Twitter dataset stores ground-truth labels under "labels" instead of "true_claims"
LABEL_FIELD = "labels" if args.split == "twitter" else "true_claims"
...
VARIANTS = OrderedDict([
    ...
    ("4b_recot", {
        ...
        "twitter_file": "cards-qwen-35-4b.jsonl",
    ...
    ("9b_recot", {
        ...
        "twitter_file": "cards-qwen-35-9b.jsonl",
        "label": "Qwen3.5-9B RECoT",
        "training_data": "1791",
    }),
    ("27b_recot", {
        "file": "cards_qwen35_27b_recot_full.jsonl",
        "twitter_file": "cards-qwen-35-27b.jsonl",
        "label": "Qwen3.5-27B RECoT",
        "training_data": "1791",
    }),
    ("36_27b_recot", {
        "file": "cards_qwen_36_27b.jsonl",
        "twitter_file": "cards-qwen-36-27b.jsonl",
        "label": "Qwen3.6-27B RECoT",
        "training_data": "1791",
    }),
    ("gpt4o_mini", {
    ...
    ("claude_opus_46", {
        ...
        "twitter_file": "claude-opus-4-6.jsonl",
        "label": "Claude Opus 4.6",
        "training_data": "—",
    }),
    ("claude_opus_47", {
        "file": "claude-opus-4-7.jsonl",
        "twitter_file": "claude-opus-4-7.jsonl",
        "label": "Claude Opus 4.7",
        "training_data": "—",
    }),
    ("gpt55", {
        "file": "gpt_5_5.jsonl",
        "twitter_file": "gpt-5-5.jsonl",
        "label": "GPT-5.5",
        "training_data": "—",
    }),
    ("cards_flash_opus", {
    ...
    ("27b_fp8", {
        "file": "cards_qwen35_27b_fp8.jsonl",
        "twitter_file": "cards-qwen-35-27b-fp8.jsonl",
        "label": "Qwen3.5-27B FP8",
        "training_data": "1791 (quant)",
    }),
])
...
def main():
    ...
    for key, cfg in VARIANTS.items():
        file_key = "twitter_file" if args.split == "twitter" else "file"
        if file_key not in cfg:
            continue
        filenames = cfg[file_key] if isinstance(cfg[file_key], list) else [cfg[file_key]]
        path = None
        ...
        def extract_preds(row):
            ...
            if isinstance(resp, list):
                ...
                # some chat models wrap response as [text, usage_dict].
                if resp and isinstance(resp[0], str):
                    return parse_response(resp[0])
